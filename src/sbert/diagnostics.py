...
Jedes Paar testet ein spezifisches linguistisches Phänomen, das
Embedding-basierte Ähnlichkeitsmodelle vor Herausforderungen stellt.
Das Feld ``expected`` gibt die semantisch korrekte Kategorie an –
Abweichungen des Modells sind aufschlussreich für die Fehleranalyse.
...
Negation
    ...
    Bekannte Schwäche: SBERT behandelt negierte Sätze oft als ähnlich,
    weil sich die Token-Vektoren kaum unterscheiden.
...
DIAGNOSTIC_PAIRS: list[DiagnosticPair] = [
    ...
    # Bekannte Schwäche: SBERT unterschätzt den Effekt von Negation,
    # weil 'nicht' nur ein einziges Token mit geringem Gewicht ist.
    {
        "id":        "diag_03",
        "category":  "Negation",
    ...
    # SBERT könnte die strukturelle Ähnlichkeit überbewerten.
    {
        ...
        "sentence2": "Olaf Scholz ist Bundeskanzler von Deutschland.",
        "expected":  "teilweise ähnlich",
    },
    {
        "id":        "diag_08",
        "category":  "Eigennamen",
        "sentence1": "Der FC Bayern München gewann die Meisterschaft.",
        "sentence2": "Borussia Dortmund verlor das Finale.",
        "expected":  "teilweise ähnlich",
    },
